...
with tab1:
    ...
    try:
        ...
        st.download_button("📥 전처리된 CSV 다운로드", df.to_csv(index=False),
                           "official_data.csv", "text/csv")
...
with tab2:
    ...
    st.download_button("📥 사용자 데이터 CSV 다운로드", df_user.to_csv(index=False),
...
with tab3:
    ...
    st.write(
        ...
        해수면은 연평균 약 **3.03mm**씩 상승하는 추세를 보이고 있으며,  
